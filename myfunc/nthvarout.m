...
% Example: 
%   Conventionally, to get the location of the maximum element in a 1D
%   array A you would use: [~, i] = max(A); however, in an annonymous
%   function it is impossible to define new variables (static workspace?)
%   and to be able to access functions' outputs that are not first in line
%   we must use a workaroud like so: 
